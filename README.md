...
Kód je v aktuálním stavu funkčí, avšak není bez chyb / bugů:
  ...
  bug: Z nějakého důvodu je nastavování frekvence strašně nepřesný. Všiml jsem si toho, když jsem nastavil 1Hz, a doba periody byla přibližně 2,5s ???
  ...
  připomínka: Použití přerušení by tuhle úlohu strašně ulehčilo. Protože není, tak v hlavní smyčce je dohromady vzorkování a výpočty s doubly, což dělá to časování nepřesný. Například když jsou oba kanály nastavený na stejnou frekvenci, tak je mezi nimi lehký offset.
